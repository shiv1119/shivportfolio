    ...
    <Col xs={24} sm={24} md={24} lg={24} xl={24}>
        <Row gutter={[20,10]}>
            ...
            <Col xs={24} sm={24} md={24} lg={12} xl={12} className='profile_info_flex_col'>
                <div className='profile_info_flex profile_info_padding' style={{background: "linear-gradient(90deg, rgba(24,24,24,0.1026611328125) 0%, rgba(184,184,184,0.09705889191614148) 14%, rgba(45,45,45,0.1026611328125) 100%)", backdropFilter:"blur(300px)"}}>
