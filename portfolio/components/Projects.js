    ...
    <>
      <Row gutter={20} id="projects">
        <Col
          ...
          className="large_medium_text main_title"
        >
          Projects
        </Col>
        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24} style={{ display: "flex" }}>
          <Row gutter={[20, 20]}>
            {cardDetails.map((details) => (
              <Col key={details.id} xs={12} sm={12} md={8} lg={8} xl={8}>
                <div>
      ...
      <Row>
        ...
        >
          <div>
            <a className="git_link small_text" href="https://github.com/shiv1119?tab=repositories">
              Click For More
            </a>
          </div>
        </Col>
